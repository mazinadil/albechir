          ...
          <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-12 lg:gap-16 items-start">
            ...
            <div className="space-y-10">
              ...
              <motion.div
                ...
                className="p-6 rounded-2xl bg-[#25D366]/[0.06] border border-[#25D366]/15 relative overflow-hidden"
              >
                <div className="absolute -top-10 -right-10 w-24 h-24 bg-[#25D366]/10 rounded-full blur-xl" />
                
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl bg-[#25D366]/20 text-[#25D366] flex items-center justify-center flex-shrink-0">
                    <WhatsAppIcon className="w-6.5 h-6.5 text-[#25D366]" />
                  </div>
                  <div className="space-y-3.5 flex-1">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#25D366] text-white text-xs font-bold rounded-xl shadow-md shadow-[0_4px_14px_rgba(37,211,102,0.22)] hover:shadow-lg hover:shadow-[0_6px_20px_rgba(37,211,102,0.35)] hover:-translate-y-0.5 transition-all duration-300 hover:bg-[#20ba5a]"
                    >
