          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-6 sm:p-10 shadow-[0_16px_40px_rgba(15,23,42,0.02)] text-gray-600 space-y-8">
            <div className="space-y-4">
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
                Welcome to <strong className="font-bold text-gray-950">AL Bechir for Global Buisness LLC</strong>. These Terms &amp; Conditions (&quot;Terms&quot;) govern your access to and use of our website, located at <a href="https://www.albechir.com" className="text-brand-blue hover:underline font-medium">www.albechir.com</a> (the &quot;Site&quot;), including any consultations, marketing services, landing pages, Meta Ads campaigns, and websites built or hosted by us (collectively, the &quot;Services&quot;).
              </p>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">1. Scope of Services</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">2. Free Consultations and Strategy Audits</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">3. Payment Terms</h2>
              <ul className="list-disc pl-6 space-y-2 text-[15px] sm:text-base text-gray-600">
                <li><strong className="font-semibold text-gray-950">Retainers &amp; Deposits:</strong> Paid design, development, or marketing setup services require a deposit or upfront retainer payment before project kick-off, as detailed in your specific invoice or statement of work.</li>
                <li><strong className="font-semibold text-gray-950">Meta Ads Budgets:</strong> Clients are solely responsible for funding their own ad budgets directly via their Meta Business Suite/Ad Account billing profiles. Our service fees cover strategy, creation, management, and continuous optimization, and do not include direct advertising media spend.</li>
                <li><strong className="font-semibold text-gray-950">Late Payments:</strong> We reserve the right to halt website builds, pause running ad campaigns, or restrict system access if invoices remain unpaid past their agreed due dates.</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">4. Client Obligations</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">5. Communication Standards</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
                For speed and reliability, our primary communication channel is <strong className="font-bold text-gray-950">WhatsApp</strong> and direct email (<a href="mailto:info@albechir.com" className="text-brand-blue hover:underline font-medium">info@albechir.com</a>). By initiating a chat via our floating widget or buttons, you agree to receive digital strategy audits, campaign updates, drafts, and technical queries directly via WhatsApp.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">6. Intellectual Property</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">7. Limitation of Liability</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
              ...
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
                In no event will <strong className="font-bold text-gray-950">AL Bechir for Global Buisness LLC</strong>, its directors, or employees be liable for any direct, indirect, incidental, or consequential damages (including loss of business profits, data corruption, domain downtime, or paused ad accounts) arising out of the use of our Site, Services, or third-party hostings.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">8. Governing Law</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
                These Terms and any dispute arising from your use of this Site or Services will be governed by and construed in accordance with the laws of the <strong className="font-semibold text-gray-950">Emirate of Dubai</strong> and the federal laws of the <strong className="font-semibold text-gray-950">United Arab Emirates (UAE)</strong>. Any disputes will be subject to the exclusive jurisdiction of the competent courts of Dubai.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-950">9. Contact Information</h2>
              <p className="text-[15px] sm:text-base text-gray-600 leading-relaxed">
