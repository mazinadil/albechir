...
export function Footer() {
  return (
    <>
      <footer className="relative bg-brand-navy-light border-t border-white/[0.04] overflow-hidden">
        {/* Background accent */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          >
            <Link
              href="/"
              className="relative mb-5 block h-11 w-[210px] transition-opacity hover:opacity-90"
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <Link
                    ...
                    className="w-9 h-9 rounded-xl bg-white/[0.04] border border-white/[0.04] flex items-center justify-center text-gray-500 hover:bg-brand-blue/10 hover:border-brand-blue/20 hover:text-brand-blue transition-all duration-300"
            ...
            <ul className="space-y-3.5">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-gray-500 text-sm hover:text-white transition-colors duration-200 group"
                >
                  <div className="w-7 h-7 rounded-lg bg-white/[0.04] flex items-center justify-center group-hover:bg-brand-blue/10 transition-colors duration-200">
